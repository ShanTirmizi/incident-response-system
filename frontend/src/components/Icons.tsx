...
export function CheckIcon({ className, ...props }: IconProps) {
  return (
    <svg className={className || "w-5 h-5"} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
...
export function SpinnerIcon({ className, ...props }: IconProps) {
  return (
    <svg className={`animate-spin ${className || "w-5 h-5"}`} fill="none" viewBox="0 0 24 24" {...props}>
