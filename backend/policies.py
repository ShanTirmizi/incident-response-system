# Policies and Procedures document content for reference by the AI
# This provides the policies context for analyzing incidents
...
# Incident report form template structure
INCIDENT_FORM_TEMPLATE = {
    "date_and_time_of_incident": {"type": "DateTime", "description": "When the incident occurred"},
    "service_user_name": {"type": "Str", "description": "Name of the service user involved"},
    "location_of_incident": {"type": "Str", "description": "Where the incident took place"},
    "type_of_incident": {"type": "Str", "description": "Category of incident (e.g., Fall, Injury, Medical)"},
    "description_of_incident": {"type": "Str", "description": "Detailed account of what happened"},
    "immediate_actions_taken": {"type": "Str", "description": "What was done immediately after the incident"},
    "was_first_aid_administered": {"type": "Boolean", "description": "Whether first aid was given"},
    "were_emergency_services_contacted": {"type": "Boolean", "description": "Whether 999 or GP was called"},
    "who_was_notified": {"type": "Str", "description": "List of people notified about the incident"},
    "witnesses": {"type": "Str", "description": "Names of any witnesses"},
    "agreed_next_steps": {"type": "Str", "description": "Actions agreed upon following the incident"},
    "risk_assessment_needed": {"type": "Boolean", "description": "Whether a risk assessment is required"},
    "if_yes_which_risk_assessment": {"type": "Str", "description": "Type of risk assessment if needed"}
}
